...
| **D3.5** ▸ **BUILT 2026-08-31 — the reading is `docs/contracts/PHASE-3-HISTORY-REVIEW.md`, every finding ruled; O-28's close is the director's read of it** | **O-28 — the git-history review.** A one-time look backwards over the full history as a stranger would read it, before anything is public. Findings reported to the director with proposed dispositions; **the director rules each**, including the recorded local-paths finding (**Q19**). The review's reading is written down and dated. **Nothing goes public before the director closes this review** | **O-28** · CLAUDE.md rule 20 · SECURITY.md §3.8 |
...
| O-28 ▸ **reading written 2026-08-31, every finding ruled; the close is the director's read (R3.2)** | Git-history review before publication — `docs/contracts/PHASE-3-HISTORY-REVIEW.md` | **D3.5** |
